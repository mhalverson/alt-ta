...
route = [
    ...
    {   KEY_NOTES: '6 km',
        KEY_LINKS: ['https://www.doc.govt.nz/parks-and-recreation/places-to-go/nelson-tasman/places/abel-tasman-national-park/things-to-do/huts/whariwharangi-hut/'],
    ...
    {   KEY_WAYPOINTS: (latlng_separation_point, (-40.8043, 173.0060), (-40.8165, 172.9772), (-40.8328, 172.9683),),
        KEY_NOTES: '21 km ish',
        KEY_LINKS: [
            'https://www.doc.govt.nz/parks-and-recreation/places-to-go/nelson-tasman/places/abel-tasman-national-park/things-to-do/huts/awapoto-hut/',
            'https://www.wildthings.club/trails/tasman/takaka/separation-point-loop/',
        ],
        KEY_SHORT_DESC: 'Awapoto Hut',
        KEY_LOCATION: (-40.8627, 172.9388), },
    {   KEY_WAYPOINTS: ((-40.8983, 172.9252), (-40.9144, 172.9357), (-40.9331, 172.9286)),
        KEY_NOTES: '17 km',
        KEY_LINKS: ['https://www.doc.govt.nz/parks-and-recreation/places-to-go/nelson-tasman/places/canaan-downs-scenic-reserve/things-to-do/campsites/canaan-downs-campsite/'],
    ...
    {   KEY_WAYPOINTS: ((-40.8719, 172.8059), (-40.9079, 172.7648), (-40.8968, 172.7465), (-40.8970, 172.7300), (-40.9011, 172.7256), (-40.8994, 172.7124), (-40.9230, 172.6869), (-40.9320, 172.6213)),
        ...
        KEY_LINKS: ['https://www.doc.govt.nz/parks-and-recreation/places-to-go/nelson-tasman/places/kahurangi-national-park/things-to-do/tracks/anatoki-and-historic-kill-devil-pack-tracks/'],
        KEY_SHORT_DESC: 'Anatoki Forks Hut',
        KEY_LOCATION: (-40.9396, 172.6084), },
    {   KEY_WAYPOINTS: (),
        KEY_NOTES: '5-6 hrs',
        KEY_LINKS: ['https://www.doc.govt.nz/globalassets/documents/parks-and-recreation/tracks-and-walks/nelson-marlborough/douglas-range-guide.pdf'],
    ...
    {   KEY_WAYPOINTS: ((-41.1407, 172.6252), (-41.1474, 172.6044), (-41.1853, 172.6296), (-41.2153, 172.5904)),
        ...
        KEY_LINKS: [
            'https://nelsontrails.co.nz/balloon-hut/',
            'https://www.doc.govt.nz/parks-and-recreation/places-to-go/nelson-tasman/places/kahurangi-national-park/things-to-do/tracks/leslie-karamea-track/',
        ],
        KEY_SHORT_DESC: 'Karamea Bend Hut',
        KEY_LOCATION: (-41.2329, 172.5109), },
    {   KEY_WAYPOINTS: ((-41.2933, 172.4685),),
        KEY_NOTES: '7.5 hrs',
        KEY_LINKS: ['https://www.doc.govt.nz/parks-and-recreation/places-to-go/nelson-tasman/places/kahurangi-national-park/things-to-do/tracks/leslie-karamea-track/'],
    ...
    {   KEY_WAYPOINTS: ((-41.3842, 172.4189), point_trevor_carter),
        ...
        KEY_LINKS: [
            'https://tramping.net.nz/huts-kahurangi/wangapeka-saddle-campsite-kahurangi-national-park',
            'https://www.doc.govt.nz/parks-and-recreation/places-to-go/nelson-tasman/places/kahurangi-national-park/things-to-do/tracks/leslie-karamea-track/',
    ...
    {   KEY_WAYPOINTS: ((-41.4265, 172.4278), (-41.4538, 172.4242), (-41.4799, 172.3945), (-41.5032, 172.4002)),
        KEY_NOTES: '12 hrs',
        KEY_LINKS: ['https://www.doc.govt.nz/parks-and-recreation/places-to-go/nelson-tasman/places/kahurangi-national-park/things-to-do/tracks/matiri-valley-and-1000-acre-plateau-tramping-tracks/'],
...
alternate_routes = [
  [
    ...
    { KEY_WAYPOINTS: ((-40.5003, 172.6853), (-40.5146, 172.6471), (-40.5302, 172.6376), (-40.5540, 172.6308), (-40.5842, 172.6325), (-40.5965, 172.5803), (-40.6154, 172.5510), (-40.6397, 172.5596), (-40.6962, 172.5409), (-40.7194, 172.5806), (-40.7797, 172.5591), (-40.8227, 172.5791), (-40.8425, 172.5581), (-40.8798, 172.5832), (-40.9003, 172.5793), (-40.9191, 172.5534), (-40.9334, 172.5553), (-40.9393, 172.5498), (-40.9430, 172.5517)),
      KEY_LINKS: ['https://www.wildthings.club/trails/tasman/takaka/boulder-lake-to-anatoki-forks/?'],
  ...
  [
    ...
    { KEY_WAYPOINTS: ((-41.3888, 172.3652), (-41.3972, 172.2952), (-41.3697, 172.2666), (-41.4229, 172.2426), (-41.4670, 172.2770), (-41.4664, 172.2388), (-41.4957, 172.2340), (-41.5147, 172.1969), (-41.5481, 172.1787), (-41.6056, 172.1994), (-41.6865, 172.2025), (-41.7234, 172.0984)),
      KEY_LINKS: ['http://remotehuts.co.nz/huts/Johnson_Hut/'],
...
for i, day in enumerate(route):
    ...
    for j, link in enumerate(day.get(KEY_LINKS, [])):
        popup_text.append(linkify(link, 'link' + str(j + 1)))
    folium.PolyLine(
        locations=leg,
        color='#ce4429',
        weight=5,
